...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ARKOSCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ARKOSCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ARKOSCOIN features */
        {"arkoscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"arkoscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"arkoscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"arkoscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"arkoscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"arkoscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"arkoscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"arkoscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"arkoscoin", "startmasternode", &startmasternode, true, true, false},
        {"arkoscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"arkoscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"arkoscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"arkoscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"arkoscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"arkoscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"arkoscoin", "preparebudget", &preparebudget, true, true, false},
        {"arkoscoin", "submitbudget", &submitbudget, true, true, false},
        {"arkoscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"arkoscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"arkoscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"arkoscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"arkoscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"arkoscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"arkoscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"arkoscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"arkoscoin", "mnsync", &mnsync, true, true, false},
        {"arkoscoin", "spork", &spork, true, true, false},
        {"arkoscoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzarkosseed", &getzarkosseed, false, false, true},
        {"zerocoin", "setzarkosseed", &setzarkosseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzarkos", &searchdzarkos, false, false, true},
        {"zerocoin", "dzarkosstate", &dzarkosstate, false, false, true},
...
{
    return "> arkoscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29785/\n";
}
