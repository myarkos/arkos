...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ARKOSCOIN Core arkoscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  arkoscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arkoscoin transaction") + "\n" +
                               "  arkoscoin-tx [options] -create [commands]   " + _("Create hex-encoded arkoscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arkoscoin transaction
