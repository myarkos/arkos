...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ARKOSCOIN Core"),
     ...
     * override -datadir in the arkoscoin.conf file in the default data directory
     * (to be consistent with arkoscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
