...
/* ARKOSCOIN GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ARKOSCOIN"
#define QAPP_ORG_DOMAIN "arkoscoin.org"
#define QAPP_APP_NAME_DEFAULT "ARKOSCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "ARKOSCOIN-Qt-testnet"
