...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ARKOS);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeARKOSCOINAmount"))
        SoftSetArg("-anonymizearkoscoinamount", settings.value("nAnonymizeARKOSCOINAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in arkoscoin.cpp during shotdown to also remove the window positions
