                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzARKOSPathCustom = GetArg("-zarkosbackuppath", "");
    ...
    if(!strzARKOSPathCustom.empty()) {
        ui->wallet_customzarkosbackuppath->setText(QString::fromStdString(strzARKOSPathCustom));
        ui->wallet_customzarkosbackuppath_label->setVisible(true);
        ui->wallet_customzarkosbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzARKOSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ARKOSCOIN RPC console.") + "<br>" +
