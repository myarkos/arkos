...
/** Utility functions used by the ARKOSCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ARKOSCOIN addresses in monospace font
...
// Parse "arkoscoin:" URI into recipient object, return true on successful parsing
