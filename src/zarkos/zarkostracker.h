...
#ifndef ARKOSCOIN_ZARKOSTRACKER_H
#define ARKOSCOIN_ZARKOSTRACKER_H
...
public:
    CzARKOSTracker(std::string strWalletFile);
    ~CzARKOSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzARKOSWallet* zARKOSWallet = NULL);
...
#endif //ARKOSCOIN_ZARKOSTRACKER_H
