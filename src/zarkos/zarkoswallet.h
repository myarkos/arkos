...
#ifndef ARKOSCOIN_ZARKOSWALLET_H
#define ARKOSCOIN_ZARKOSWALLET_H
...
public:
    CzARKOSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZARKOS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZARKOS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //ARKOSCOIN_ZARKOSWALLET_H
