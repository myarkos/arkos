...
from fake_stake.base_test import ARKOSCOIN_FakeStakeTest

class zARKOSwrappedSerialsTest(ARKOSCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zARKOSs..." % DENOM_TO_USE)
