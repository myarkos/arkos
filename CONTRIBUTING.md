Contributing to ARKOSCOIN Core
============================

The ARKOSCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/arkoscoin-project/arkoscoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ARKOSCOIN Core project, and is not to be
confused with overall ARKOSCOIN Network Protocol consensus changes.

Whether a pull request is merged into ARKOSCOIN Core rests with the project merge
...
Patches that change ARKOSCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the ARKOSCOIN consensus, it must have been
...
The project leader is the release manager for each ARKOSCOIN Core release.
