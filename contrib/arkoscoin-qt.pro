...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/arkoscoin-cli.cpp \
           src/arkoscoin-tx.cpp \
           src/arkoscoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/arkoscoin.qrc src/qt/arkoscoin_locale.qrc

TRANSLATIONS += src/qt/locale/arkoscoin_bg.ts \
                src/qt/locale/arkoscoin_de.ts \
                src/qt/locale/arkoscoin_en.ts \
                src/qt/locale/arkoscoin_es.ts \
                src/qt/locale/arkoscoin_fi.ts \
                src/qt/locale/arkoscoin_fr.ts \
                src/qt/locale/arkoscoin_it.ts \
                src/qt/locale/arkoscoin_ja.ts \
                src/qt/locale/arkoscoin_pl.ts \
                src/qt/locale/arkoscoin_pt.ts \
                src/qt/locale/arkoscoin_ru.ts \
                src/qt/locale/arkoscoin_sk.ts \
                src/qt/locale/arkoscoin_sv.ts \
                src/qt/locale/arkoscoin_vi.ts \
                src/qt/locale/arkoscoin_zh_CN.ts \
                src/qt/locale/arkoscoin_zh_TW.ts
